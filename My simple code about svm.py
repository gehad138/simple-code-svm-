...
data1 = loadmat("D:\\New folder\\ex6data1")
#print(data1)
y1 = data1['y']
X1 = data1['X']
...
data2 = loadmat("D:\\New folder\\ex6data2")
print (data2)
y2 = data2['y']
X2 = data2['X']
print('X2 :',X2.shape)
...
data3 = loadmat("D:\\New folder\\ex6data3")
print(data3)
y3 = data3['y']
X3 = data3['X']
print('X3 :',X3.shape)
...
spam_train = loadmat('D:\\New folder\\spamTrain.mat')
spam_test = loadmat('D:\\New folder\\spamTest.mat')
